...
export function OverviewSection({ generateId }: OverviewSectionProps) {
  ...
  return (
    <FormSection value="sub-item-3" title="Overview Section">
      ...
      <FormField control={control} name="propertyDetailPage.propertyOverviewSection.reraLogo" render={({ field }) => (<FormItem><FormLabel>RERA Logo URL</FormLabel><FormControl><Input type="url" {...field} /></FormControl><FormMessage /></FormItem>)} />
      ...
      <FormField control={control} name="propertyDetailPage.propertyOverviewSection.projectOverviewImageUrl" render={({ field }) => (<FormItem><FormLabel>Project Overview Image URL</FormLabel><FormControl><Input type="url" {...field} /></FormControl><FormMessage /></FormItem>)} />
