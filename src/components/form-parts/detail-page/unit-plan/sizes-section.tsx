      ...
      <div className="space-y-4">
        ...
        {fields.map((field, index) => (
          <div key={field.id} className="p-4 border rounded-md space-y-4">
            ...
            <FormField control={control} name={`propertyUnitPlanDetailPage.propertyUnitSizesSection.unitSizesWithinTower.${index}.price`} render={({ field }) => (<FormItem><FormLabel>Price</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>)} />
