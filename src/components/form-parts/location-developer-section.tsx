...
export function LocationDeveloperSection() {
  ...
  return (
    <FormSection value="item-8" title="Location and Developer" description="Provide location and developer details for the property.">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField control={control} name="address" render={({ field }) => ( <FormItem className="md:col-span-2"><FormLabel>Full Address</FormLabel><FormControl><Textarea placeholder="Enter the complete property address" {...field} /></FormControl><FormMessage /></FormItem> )} />
          ...
          <FormField control={control} name="developer" render={({ field }) => ( <FormItem><FormLabel>Developer Name</FormLabel><FormControl><Input placeholder="e.g., Sattva Group" {...field} /></FormControl><FormMessage /></FormItem> )} />
